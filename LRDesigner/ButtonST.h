...
public:
	...
	bool SetBtnCursor(WTL::_U_STRINGorID nCursorId, HMODULE rsrcModule = 0);
	//! Sets the icons of the button
	DWORD SetIcon(HICON hIconIn, HICON hIconOut);
	//! Sets the icons of the button
	DWORD SetIcon(WTL::_U_STRINGorID nIconInId, WTL::_U_STRINGorID nIconOutId = 0U, HMODULE rsrcModule = 0);
	...
	//! Sets the bitmaps of the button
	DWORD SetBitmaps(WTL::_U_STRINGorID nBitmapIn, COLORREF crTransColorIn, WTL::_U_STRINGorID nBitmapOut = 0U, COLORREF crTransColorOut = 0, HMODULE rsrcModule = 0);
