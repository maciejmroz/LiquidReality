...
DWORD CButtonST::SetIcon(WTL::_U_STRINGorID nIconInId, WTL::_U_STRINGorID nIconOutId, HMODULE rsrcModule)
{
	HICON		hIconIn;
	HICON		hIconOut;
...
bool CButtonST::SetBtnCursor(WTL::_U_STRINGorID nCursorId, HMODULE rsrcModule)
{
	HINSTANCE hInstResource;
...
void CButtonST::InitToolTip()
{
	if (m_ToolTip.m_hWnd == 0)
		...
		m_ToolTip.Create(*this,NULL,NULL,TTS_BALLOON);
		// Create inactive
...
DWORD CButtonST::SetBitmaps(WTL::_U_STRINGorID nBitmapIn, COLORREF crTransColorIn, WTL::_U_STRINGorID nBitmapOut, COLORREF crTransColorOut, HMODULE rsrcModule)
{
	HBITMAP		hBitmapIn	= 0;
